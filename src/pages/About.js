            ...
            <div className="about-background">
                ...
                <section class="vision-section">
                    ...
                    <div class="vision-card">
                        ...
                        <p class="card-description">
                            We are building a fleet of autonomous satellite agents equipped with robotic arms that our customers can hire to service and assemble spacecraft in orbit. Our solution leverages a standardized hardware design paired with software capable of adapting to our customers missions. Rather than re-programming for each mission, our users provide high-level instructions then are quickly delivered a mission plan with analytics such as cost, completion time, and success probability.
